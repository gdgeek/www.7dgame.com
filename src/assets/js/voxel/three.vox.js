...
THREE.BaseGeometry.prototype.buildInputRange = function(p, begin, range) {
    ...
    return new Promise(function(resolve) {
        for (var i = begin; i < p.vox.length && i < begin + range; i++) {
            ...
            // Example process to add vertices
            // This is simplified; adapt it as necessary to match the full logic you need
            if (!p.map['p_' + x + '_' + y + '_' + (z - 1)]) {
                // Process like adding vertices, calculating 'm', pushing indices, and setting colors
                // The actual logic of what you do in here will depend on your application's needs
            }

            // Similar for other conditions...

            // The specific logic inside each condition has been omitted for brevity
            // Replace it with your actual processing logic as needed
        }
